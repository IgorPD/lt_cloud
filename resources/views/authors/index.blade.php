       ...
       @foreach($authors as $author)
        ...
        <!--<td>{{ $author->id }}</td>-->
           ...
           <td>
             ...
             <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal{{ $author->id }}">
               Excluir
             </button>
               ...
               <div class="modal-dialog">
                 <div class="modal-content">
                   <div class="modal-header">
                     <h5 class="modal-title" id="confirmDeleteModalLabel{{ $author->id }}">Confirmar Exclusão</h5>
